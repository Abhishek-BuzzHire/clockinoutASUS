                ...
                <div key={edu.id} className={cardCls}>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className={fieldCls}>
                            ...
                            <input
                                ...
                                onChange={(e) => update(i, { fieldOfStudy: e.target.value || null })}
                            />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className={fieldCls}>
                            ...
                            <input
                                ...
                                placeholder="2018"
                                value={edu.startYear ?? ""}
                                onChange={(e) => update(i, { startYear: e.target.value || null })}
                            />
                        </div>
                        <div className={fieldCls}>
                            ...
                            <input
                                ...
                                placeholder="2022"
                                value={edu.endYear ?? ""}
                                onChange={(e) => update(i, { endYear: e.target.value || null })}
                            />
                        </div>
                        <div className={fieldCls}>
                            ...
                            <input
                                className={inputCls}
                                placeholder="8.5 / First Class"
                                value={edu.grade ?? ""}
                                onChange={(e) => update(i, { grade: e.target.value || null })}
                            />
                        </div>
                    </div>
                    ...
                    <div className={fieldCls}>
                        ...
                        <input
                            ...
                            onChange={(e) => update(i, { activities: e.target.value || null })}
                        />
                    </div>
                </div>
            ))}
