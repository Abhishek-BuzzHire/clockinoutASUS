                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className={fieldCls}>
                            ...
                            <input
                                ...
                                value={exp.jobTitle ?? ""}
                                onChange={(e) => update(i, { jobTitle: e.target.value || null })}
                            />
                        </div>
                        <div className={fieldCls}>
                            ...
                            <input
                                ...
                                value={exp.company ?? ""}
                                onChange={(e) => update(i, { company: e.target.value || null })}
                            />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className={fieldCls}>
                            ...
                            <select
                                ...
                                onChange={(e) => update(i, { employmentType: (e.target.value as EmploymentType) || null })}
                            >
                        ...
                        <div className={fieldCls}>
                            ...
                            <label className="flex items-center gap-2 text-xs text-gray-500 cursor-pointer mt-1 select-none">
                                <input
                                    ...
                                    onChange={(e) =>
                                        update(i, { isCurrent: e.target.checked, endDate: e.target.checked ? null : exp.endDate })
                                    }
                                />
